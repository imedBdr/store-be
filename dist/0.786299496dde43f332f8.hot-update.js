...
let ClientPaymentService = class ClientPaymentService {
    ...
    async CheckExistanceClientPayment(client) {
        if (client.account_number && client.client && client.expiry && client.payment_type && client.provider) {
            if (this.GetClientPaymentByAccount(client.account_number))
                ;
        }
        else
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("79ad9b2d11e1969b2280")
/******/ })();
/******/ 
/******/ }
;